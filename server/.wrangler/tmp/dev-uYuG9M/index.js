...
// .wrangler/tmp/bundle-nMJJaP/checked-fetch.js
...
// src/generateAI.ts
var PROMPT_PREFIX = `You are a professional gym trainer, Analyze the following factors to achieve the desired goals for a person based on their gender living in India. Provide a detailed workout split and diet plan, formatted in HTML using appropriate tags such as <h1>, <h2>, <ul>, and <li>. Ensure the response is neatly structured with clear headings and bullet points. 
...
// .wrangler/tmp/bundle-nMJJaP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-nMJJaP/middleware-loader.entry.ts
